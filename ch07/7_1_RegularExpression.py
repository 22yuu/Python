...
print(findall('[0-9]{3,}', str1)) # {start_index,end_index} 연속 3자리 이상
...
print(findall('^test', str2)) # ^ 캐럿? 시작을 의미함 45test의 test는 출력이 안됨!!
print(findall('st$', str2)) # $는 finish를 의미

# 단어 검색
str3 = 'test^홍길동 abc 대한*민국 123$tbc'

print(findall('\\w{3,}', str3)) # \\w 3글자 이상 단어들을 탐색
